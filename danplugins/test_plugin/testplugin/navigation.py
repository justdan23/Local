"""Navigation Items to add to Nautobot for test_plugin."""
...
menu_items = (
    PluginMenuItem(
        link='plugins:test_plugin:model',  # A reverse compatible link to follow.
        ...
        buttons = (  # Optional: Iterable of PluginMenuButton instances to display.
            PluginMenuButton(
                'plugins:test_plugin:model',  # A reverse compatible link to follow.
